...
class Dashboard(ctk.CTkScrollableFrame):
    ...
    def __init__(self, master):
        ...
        self.refresh_butt.grid(row=1, column=0, pady=10, padx=10)

    def main_label(self):
        label = ctk.CTkLabel(master=self, text="Dashboard", font=("", 38, "bold"))
    ...
    def create_cards(self):
        self.balance = Flashcard(self, "Balance", "0.0", "#478af5")
        self.expenses = Flashcard(self, "Expenses", self.get_values("expenses"), "#478af5")
...
class Flashcard(ctk.CTkFrame):
    ...
    def __init__(self, master, title, text, color):
        ...
        self.text = ctk.CTkLabel(self, text=text, font=("", 14), text_color="black")
        self.display_text()
